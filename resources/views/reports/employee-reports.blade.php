                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html" class="text-primary">Sunil Rana <span>#0001</span></a>
                                        </h2>
                                    </td>
                                    <td>Employee</td>
                                    <td class="text-info">sunilrana201@gmail.com</td>
                                    <td>Design</td>
                                    <td>UI Design</td>
                                    <td>25 Jul 2023</td>
                                    <td>26 May 2002</td>
                                    ...
                                    <td>$20000</td>
                                    <td>
                                        Datta Nagar, Bhosari, Pune, MH, 411039
                                    </td>
                                    <td>9876543210</td>
                                    <td>7894561235</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html" class="text-primary">Richa Soni <span>#0002</span></a>
                                        </h2>
                                    </td>
                                    <td>Employee</td>
                                    <td class="text-info">richa457@gmail.com</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html" class="text-primary">Amit Salve <span>#003</span></a>
                                        </h2>
                                    </td>
                                    <td>Employee</td>
                                    <td class="text-info">amitsalve@gmail.com</td>
                                    <td>IOS Developer</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html" class="text-primary">Sumit Sharma <span>#004</span></a>
                                        </h2>
                                    </td>
                                    <td>Employee</td>
                                    <td class="text-info">Sumit235@gmail.com</td>
                                    <td>Web Developer</td>
                                    <td>IT Support</td>
                                    <td>15 Nov 2020</td>
                                    <td>15 Jul 2005</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html" class="text-primary">Kunal Sharma <span>#005</span></a>
                                        </h2>
                                    </td>
                                    <td>Employee</td>
                                    <td class="text-info">Kunal3520@gmail.com</td>
                                    <td>Team Leader</td>
                                    <td>Development Manager</td>
                                    <td>01 Dec 2022</td>
                                    <td>21 Jun 1996</td>
