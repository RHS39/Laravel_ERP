    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="card dash-widget">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-inr"></i></span>
                            <div class="dash-widget-info">
                            ...
                            <div class="leave-info-box">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <div class="text-sm my-0">Nitin Sonawane</div>
                                    </div>
                                </div>
                                <div class="row align-items-center mt-3">
                                    <div class="col-6">
                                        <h6 class="mb-0">4 Sep 2023</h6> <span class="text-sm text-muted">Leave Date</span> </div>
                                ...
                                <table class="table table-nowrap custom-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h2><a href="#">Amptric Automotive</a></h2>
                                            </td>
                                            <td>11 Mar 2024</td>
                                            <td>₹ 3,80,260</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2><a href="#">Spark Solutions</a></h2> </td>
                                            <td>8 Feb 2024</td>
                                            <td>₹ 24,500</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2><a href="#">M K Enterprises</a></h2> </td>
                                            <td>23 Jan 2024</td>
                                            <td>₹ 2,60,360</td>
                                            <td>
                                ...
                                <table class="table custom-table table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="invoice-view.html">#INV-0001</a></td>
                                            <td>
                                                <h2><a href="#">Amptric Automotive</a></h2> </td>
                                            <td>UPI</td>
                                            <td>11 Mar 2024</td>
                                            <td>₹ 38,260</td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html">Pankaj Rathod <span>Director</span></a>
                                                </h2>
                                            </td>
                                            <td>pankajrathod024@gmail.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt="" src="assets/img/profiles/avatar-19.jpg"></a>
                                                    <a href="client-profile.html">Parathesh Zade <span>Manager</span></a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html">Rahul Kumar <span>Proprietor</span></a>
                                                </h2>
                                             </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html"> Ajeenkya Jadhav <span>Director</span></a>
                                                </h2>
                                            </td>
                                            <td>ajinkya@gmail.com</td>
                                            <td>
                                                <div class="dropdown action-label">
                                                    <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-dot-circle-o text-success"></i> Active </a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html"> Sayali Jadhav <span>Director</span></a>
                                                </h2>
                                            </td>
                                            <td>sayalijadhav@gmail.com</td>
                                            <td>
                                                <div class="dropdown action-label">
                                                    <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-dot-circle-o text-danger"></i> Inactive </a>
                                                    <div class="dropdown-menu dropdown-menu-right">
