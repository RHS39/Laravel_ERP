                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <div class="text">Maharashtra Bank</div>
                                        </li>
                                        <li>
                                            <div class="title">Bank account No.</div>
                                            <div class="text">1738791344212</div>
                                        </li>
                                        <li>
                                            <div class="title">IFSC Code</div>
                                            <div class="text">MHBK2450423</div>
                                        </li>
                                        <li>
                                            <div class="title">PAN No</div>
                                            <div class="text">TCSPS4507Y</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Total rate</label>
                                            <input type="text" class="form-control" placeholder="N/A" value="25%">
                                        </div>
                                    </div>
                                </div>
                                
                                <hr>
                                <h3 class="card-title"> ESICInformation</h3>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">ESICcontribution</label>
                                            <select class="select">
                                                <option>Select ESICcontribution</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">ESICNo. <span class="text-danger">*</span></label>
                                            <select class="select">
                                                <option>Select ESICcontribution</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Employee ESICrate</label>
                                            <select class="select">
                                                <option>Select ESICcontribution</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Total rate</label>
                                            <input type="text" class="form-control" placeholder="N/A" value="4%">
                                        </div>
                                    </div>
                                </div>
