                        ...
                        <table class="table table-striped custom-table datatable" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td hidden class="travel">{{ $items->travel }}</td>
                        ...
                        <form action="{{ route('form/salary/save') }}" method="POST">
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    ...
                                    <div class="form-group">
                                        <label>DA(40%)</label>
                                        <input class="form-control @error('da') is-invalid @enderror" type="number"  name="da" id="da" value="{{ old('da') }}" placeholder="Enter DA (Upto 40%)">
                                        @error('da')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <label>HRA(15%)</label>
                                        <input class="form-control @error('hra') is-invalid @enderror" type="number"  name="hra" id="hra" value="{{ old('hra') }}" placeholder="Enter HRA (Upto 15%)">
                                        @error('hra')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <label>Travel</label>
                                        <input class="form-control @error('travel') is-invalid @enderror" type="number"  name="travel" id="travel" value="{{ old('travel') }}" placeholder="Enter travel">
                                        @error('travel')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <form action="{{ route('form/salary/update') }}" method="POST">
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    ...
                                    <div class="form-group">
                                        <label>travel</label>
                                        <input class="form-control" type="text"  name="travel" id="e_travel" value="">
                                    </div>
                                    <div class="form-group">
                                        <label>Allowance</label>
    ...
    @section('script')
        ...
        <script>
            $(document).on('click','.userSalary',function()
            {
                ...
                $('#e_travel').val(_this.find('.travel').text());
