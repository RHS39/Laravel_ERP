...
use App\Http\Controllers\EmpRegisterController;
...
Route::controller(EmpRegisterController::class)->group(function () {
    Route::get('form/register_emp/new', 'Register_emp')->middleware('auth')->name('form/register_emp/new');
